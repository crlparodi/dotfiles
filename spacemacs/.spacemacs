...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(
      ...
      ;; Company special packages
      company-web

      ;; Packages prefered for ReactJS development
      dap-mode
      react-snippets
      emmet-mode

      ;; Packages for snippet and folding code
      yafolding

      ;; Packages for major modes
      ;; 1. Web/React/Sass
      web-mode
      rjsx-mode
      json-mode
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-themes '(doom-outrun-electric-brighter-comments)
...
before packages are loaded."
  ...
  (spacemacs/set-leader-keys "xlw" 'kill-whole-line)
  (spacemacs/set-leader-keys "xpH" 'yafolding-hide-all)

  (spacemacs/set-leader-keys "xps" 'yafolding-show-element)
  ...
  ;; MAXIMIZE THE WINDOW WHEN EMACS IS RUNNING
  ...
  (use-package prettier-js
    :ensure t
    :hook (web-mode-jsx . prettier-js-mode))

  (pony-setting (make-pony-project
                 :python "/home/palomino/Projects/Beaver/bin/env/"
...
(custom-set-variables
 ...
 '(beacon-color "#cc6666")
 '(custom-safe-themes
   '("6b5c518d1c250a8ce17463b7e435e9e20faa84f3f7defba8b579d4f5925f60c1" "b7e460a67bcb6cac0a6aadfdc99bdf8bbfca1393da535d4e8945df0648fa95fb" "bffa9739ce0752a37d9b1eee78fc00ba159748f50dc328af4be661484848e476" default))
