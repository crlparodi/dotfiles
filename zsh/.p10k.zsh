# Generated by Powerlevel10k configuration wizard on 2020-08-07 at 14:05 CEST.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 44495.
# Wizard options: compatible, unicode, lean_8colors, time, 2 lines, disconnected,
# no frame, compact, fluent, transient_prompt, instant_prompt=off.
